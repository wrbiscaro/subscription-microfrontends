...
const prodConfig = {
    ...
    output: {
        ...
        publicPath: '/auth-microfrontend-react/latest/' //Diretorio do bucket s3 de onde o cloudffront vai carregar arquivos públicos (js, css, etc)
    },
    plugins: [
        new ModuleFederationPlugin({
            ...
            exposes: {
                './AuthApp': './src/bootstrap' //Expoe o arquivo bootstrap com o nome 'AuthApp', para ser importado nos componentes do container
            },
